...
export const SubmitButton = ({
  ...
  return (
    <button
      onClick={onClick}
      disabled={isPending}
      className={`bg-sky-500 shadow text-white text-center rounded-md p-2 hover:bg-sky-400 hover:shadow-sky-500 hover:shadow flex gap-2 justify-center items-center min-w-max ${
