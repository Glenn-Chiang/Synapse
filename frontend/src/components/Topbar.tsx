  ...
  return (
    <nav className="z-10 bg-slate-950 w-screen h-16 shadow p-4 fixed top-0 left-0 font-medium flex items-center justify-between">
      ...
      >
        ...
        {menuIsOpen && (
          <div ref={menuRef} className="absolute z-20">
            <ProfileMenu />
          </div>
        )}
      </button>
...
const ProfileMenu = () => {
  ...
  return (
    <div className="z-20 absolute -bottom-20 right-0 flex flex-col w-max rounded-md bg-slate-900 border border-slate-500">
      <Link
