...
const LeaveChannel = () => {
  ...
  return (
    <section>
      <button onClick={() => setModalIsOpen(true)} className="flex gap-2 items-center justify-center bg-slate-900 hover:bg-slate-800 w-40 p-2 rounded-md">
  ...
  return (
    <Modal>
      ...
      <div className="flex gap-4">
        ...
        <button onClick={close} className="text-slate-500 hover:text-sky-500">Cancel</button>
      </div>
    </Modal>
  )
}
